...
namespace Owl\Bundle\SuggestionBundle\DependencyInjection;
...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('owl_suggestion');
                        ...
                        ->arrayNode('suggestion')
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('model')->defaultValue(Suggestion::class)->cannotBeEmpty()->end()
                                        ->scalarNode('controller')->defaultValue(BaseController::class)->cannotBeEmpty()->end()
                                        ->scalarNode('repository')->cannotBeEmpty()->end()
                                        ->scalarNode('factory')->defaultValue(Factory::class)->end()
                                        ->scalarNode('form')->defaultValue(SuggestionType::class)->cannotBeEmpty()
                                ->end()
                            ->end()
                        ->end()
                    ->end()
